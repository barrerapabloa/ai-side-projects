...
export const BoardingPass = forwardRef<HTMLElement, BoardingPassProps>(function BoardingPass(
  {
    passengerNo,
    givenName,
    familyName,
  ...
  return (
    <article
      ref={ref}
      className="relative overflow-hidden rounded-2xl border border-white/[0.12] bg-gradient-to-br from-zinc-900/95 via-zinc-950 to-black shadow-[0_24px_60px_-28px_rgba(0,0,0,0.95)] ring-1 ring-white/[0.06]"
    >
      <div className="flex items-start justify-between gap-3 border-b border-white/[0.08] bg-white/[0.03] px-5 py-4">
        <div className="text-left">
          ...
          <div className="mt-1 flex items-center gap-2 text-[15px] leading-none text-white">
            <BrandWordmark />
        ...
        <span className="rounded-md border border-white/[0.1] bg-black/40 px-2 py-1 text-[11px] text-zinc-400">
      ...
      <div className="px-5 py-5">
        ...
        <div className="mt-5 grid grid-cols-3 gap-3 text-center">
          ...
          <div className="rounded-lg bg-black/35 px-2 py-2 ring-1 ring-white/[0.06]">
            ...
            <p className="mt-0.5 text-sm font-semibold text-white">{seatId}</p>
          </div>
        </div>
        ...
        <div className="mt-6 space-y-2">
          ...
          <div className="flex items-center justify-between text-[11px] text-zinc-500">
            <span>Record</span>
            <span className="text-zinc-300">{pnr}</span>
          </div>
        </div>
      </div>
    </article>
